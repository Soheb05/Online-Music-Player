...
<head>
  ...
  <title>Edit artist | SoundWave</title>
        ...
        <div class="container-fluid">
		  ...
		  <div class="row">
            ...
            $error=$_FILES["artist_image"]["error"];
					  ...
					  $n=iud("UPDATE  `artist` SET `artist_name`='$category_name', `artist_image`='$image', 
            `cat_id`='$cat' where id='".$_REQUEST['id']."'");
             ...
             <form class="user" method="post" enctype="multipart/form-data">
                  <?php
         //         echo "select * from artist where id='".$_REQUEST['id']."'";
				  $a=select("select * from artist where id='".$_REQUEST['id']."'");
          ...
          <div class="form-group">
                    ...
                    <input type="file" name="artist_image" class="form-control "></div>
					<?php
				  }
					?>
